  ...
  return (
    <div className='header'>
         <div className="headerLeft">
            <NavLink to="/"><img className="header__icon" src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/IMDB_Logo_2016.svg/2560px-IMDB_Logo_2016.svg.png" alt="" /></NavLink>
